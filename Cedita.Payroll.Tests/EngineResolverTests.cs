...
namespace Cedita.Payroll.Tests
{
    ...
    public class EngineResolverTests
    {
        ...
        public void TestPayeEngineResolution()
        {
            ...
            Assert.AreEqual(typeof(PayeVersion14), DefaultEngineResolver.GetEngine<IPayeCalculationEngine>(2016).GetType());
            Assert.AreEqual(typeof(PayeVersion15), DefaultEngineResolver.GetEngine<IPayeCalculationEngine>(2017).GetType());

            // TODO: Update to latest as this goes on
            Assert.AreEqual(typeof(PayeVersion15), DefaultEngineResolver.GetEngine<IPayeCalculationEngine>(2020).GetType());
        }
        ...
        public void TestNationalInsuranceEngineResolution()
        {
            ...
            Assert.AreEqual(typeof(NationalInsurance2014), DefaultEngineResolver.GetEngine<INiCalculationEngine>(2015).GetType());
